...
class Login extends Template implements ActionListener, Runnable  
{
    ...
    Login()
    {
        ...
        TopLable.setText("Packer Unpacker : Login ");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
            this.setState(this.ICONIFIED); //this
        }
        if(ae.getSource()== SUBMIT)
        {
            ...
            if(value1.equals("PackerUnpacker")&& value2.equals("PackerUnpacker"))
            {
            ...
            else
            {
                ...
                if(attemp == 0)
                {
                    JOptionPane.showMessageDialog(this,"NUmber of attempt finishd","Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                         this.dispose();
                    System.exit(0);
                }
